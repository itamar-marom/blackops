...
// deletePipelineCmd represents the deletePipeline command
...
func init() {
	...
	// deletePipelineCmd.PersistentFlags().String("foo", "", "A help for foo")

	// Cobra supports local flags which will only run when this command
	// is called directly, e.g.:
	// deletePipelineCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
}
