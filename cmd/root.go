...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.blackops.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".blackops" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".blackops")
	}
